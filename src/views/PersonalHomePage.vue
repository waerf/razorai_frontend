    ...
    <div class="profile-container">
      <div class="profile-header">
        ...
        <div class="user-info">
          ...
          <p>积分：{{ points }}</p>
          <p>个人简介：{{ bio }}</p>
          <el-button @click="goToScoreMessage" size="mini" type="primary"
            >查看积分明细</el-button
          >
        </div>
      </div>
...
.info-group {
  width: 370px; /* 固定宽度以保持一致 */
  margin: 0 auto; /* 居中对齐 */
  padding: 15px;
  background-color: #ffffff; /* 白色背景 */
  border: 1px solid #165dff; /* 深蓝色边框 */
  border-radius: 5px;
...
.button-group el-button {
  background-color: #165dff; /* 深蓝色按钮背景 */
  color: #ffffff; /* 白色文字 */
}
</style>
